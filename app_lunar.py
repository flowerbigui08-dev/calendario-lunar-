...
st.markdown("""
    ...
    /* Forzar que los botones de mes no se amontonen */
...
# Dibujar botones de meses en 3 columnas
m_cols = st.columns(3)
for i, m_name in enumerate(meses_abr):
    with m_cols[i % 3]:
...
# 3. Leyendas (Diseño de cuadros grandes restaurado)
